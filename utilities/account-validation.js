...
/* ******************************
 * Check updated account info and return errors or continue to account view
 * ***************************** */
...
/* ******************************
 * Check updated password and return errors or continue to account view
 * ***************************** */
validate.checkUpdatePwdData = async (req, res, next) => {
  const { account_id, account_firstname, account_lastname, account_email } = req.body;
  let errors = [];
  errors = validationResult(req);
  if (!errors.isEmpty()) {
